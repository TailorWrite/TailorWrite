			...
			<Listbox value={statusSelected} onChange={handleStatusSelect}>
				<div className="relative">
					...
					<Transition
						...
						leaveTo="opacity-0"
					>
						<ListboxOptions className="absolute z-50 mt-1 max-h-60 w-34 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm dark:bg-primaryDark dark:ring-darkBorder">
