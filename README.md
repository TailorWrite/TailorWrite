...
1. Access the web application via the GitBucket Pages  distribution here: [https://isgb.otago.ac.nz/info301/TailorWrite/TailorWrite/pages/](https://isgb.otago.ac.nz/info301/TailorWrite/TailorWrite/pages/)

<!-- USAGE EXAMPLES -->
## View Project

<div align="center">
   <img style="width: 100%" src="./readme_assets/ProjectScreenshot.png">
</div>
